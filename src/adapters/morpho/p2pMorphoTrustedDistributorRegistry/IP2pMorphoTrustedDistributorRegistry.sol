...
interface IP2pMorphoTrustedDistributorRegistry {
    event P2pMorphoTrustedDistributorRegistry__TrustedDistributorSet(address indexed _newTrustedDistributor);
    event P2pMorphoTrustedDistributorRegistry__TrustedDistributorRemoved(address indexed _trustedDistributor);
