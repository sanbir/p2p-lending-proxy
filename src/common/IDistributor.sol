...
/// @notice Minimal Merkl distributor interface used for claiming rewards
interface IDistributor {
    /// @notice Claims rewards for a given set of users
    /// @dev Anyone may call this function for anyone else, funds go to the destination regardless, it's just a question of
